...
func (ini *IniConfig) Parse(filename string) (ConfigContainer, error) {
...
func (ini *IniConfig) ParseFile(filename string, container interface{}) error {
	return errors.New("ParseFile function not implement")
}
